...
import { selectHeading } from '../../helper';

import style from './HeadingButton.module.scss';
...
const RteHeadingButton = (props: any) => {
  const { theme } = props;
          ...
          {HEADING_OPTIONS.map((heading: string, i: number) => {
            return (
              <Text
                ...
                onClick={() => {
                  setActiveHeading(i);
                  selectHeading(savedSelection, i, editor);
                  setIsOpen(false);
...
export default RteHeadingButton;
